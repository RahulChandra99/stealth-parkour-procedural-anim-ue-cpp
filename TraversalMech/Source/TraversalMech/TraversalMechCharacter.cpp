...
//////////////////////////////////////////////////////////////////////////
// ATraversalMechCharacter

ATraversalMechCharacter::ATraversalMechCharacter(const FObjectInitializer& ObjectInitializer)
...
void ATraversalMechCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(ClimbAction, ETriggerEvent::Started, this, &ATraversalMechCharacter::OnClimbActionStarted);
...
void ATraversalMechCharacter::OnClimbActionStarted(const FInputActionValue& Value)
{
	if(!CustomMovementComponent)return;
